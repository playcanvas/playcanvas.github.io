...
import { TRACEID_RENDER_FRAME, TRACEID_RENDER_QUEUE } from '../core/constants.js';
...
const makeTick = function makeTick(_app) {
	...
	return function (timestamp, frame) {
		...
		if (shouldRenderFrame) {
			const tracingOn = application.frame === 50;
			Tracing.stack = tracingOn;
			Tracing.set(TRACEID_RENDER_FRAME, tracingOn);
			Tracing.set(TRACEID_RENDER_QUEUE, tracingOn);
